...
def main(input_filepath, output_filepath):
    ...
    if not path.exists(path.join(input_filepath, "flowers")):
        if not path.exists(path.join(input_filepath, "tpu-getting-started.zip")):
            download_data(input_filepath)
        extract_data(path.join(input_filepath, "tpu-getting-started.zip"))
